...
/**
 * Marketing signup for baitcastcatch.com.
 *
 ...
 */
const RESOURCE = {
  title: 'Your Fishing Trip Log Sheet',
  blurb: 'One trip on one page. Conditions at the top, then room for twelve catches, then a place to write down what you would do differently.',
  url: 'https://www.baitcastcatch.com/baitcastcatch-fishing-trip-log-sheet.pdf',
};
