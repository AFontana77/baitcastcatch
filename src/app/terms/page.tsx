      ...
      <main id="main-content" className="pt-20">
        <section className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-3">Health and Safety Notice</h2>
            <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about these terms? Email <a href="mailto:support@baitcastcatch.com" className="text-blue-700 hover:underline">support@baitcastcatch.com</a>.
            </p>
          </div>
        </section>
      </main>
