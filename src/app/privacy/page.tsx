        ...
        <section className="py-16 px-4 bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="text-gray-600 leading-relaxed mb-4">
              ...
              Contact: <a href="mailto:support@baitcastcatch.com" className="text-blue-700 hover:underline">support@baitcastcatch.com</a>
            </p>
            ...
            <ul className="list-disc pl-6 text-gray-600 mb-4 space-y-1">
              ...
              <li><strong>Catch logs you create</strong> — stored locally on your device and, if you have an account, in our secure cloud database (Supabase).</li>
            ...
            <p className="text-gray-600 leading-relaxed">
              Questions about this policy? Email <a href="mailto:support@baitcastcatch.com" className="text-blue-700 hover:underline">support@baitcastcatch.com</a>.
            </p>
          </div>
        </section>
      </main>
