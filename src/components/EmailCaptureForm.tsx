...
/**
 * Email capture for baitcastcatch.com.
 *
  ...
  return (
    <form className="flex flex-col gap-3" onSubmit={onSubmit}>
      ...
      <input
        ...
        className="w-full px-4 py-3 rounded-xl border border-blue-200 bg-white text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-700 text-base min-h-[48px]"
        name="email"
        autoComplete="email"
        value={email}
      ...
      <button
        type="submit"
        className="w-full inline-flex items-center justify-center gap-2 bg-blue-700 text-white font-semibold px-6 py-3 rounded-xl hover:bg-blue-800 transition-colors press-feedback min-h-[48px]"
        disabled={state === 'sending'}
      >
      ...
      <label className="flex items-start gap-2.5 text-sm cursor-pointer opacity-90">
        ...
        />
        <span>Send me the download and occasional fishing resources. Unsubscribe anytime.</span>
      </label>
